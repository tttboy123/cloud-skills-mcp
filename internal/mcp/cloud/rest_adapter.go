...
func responseRequestID(headers http.Header) string {
	for _, name := range []string{"X-Request-Id", "X-Amzn-Requestid", "X-Amz-Request-Id", "X-Ms-Request-Id", "X-Goog-Request-Id", "X-Firebase-Request-Id", "X-Cloud-Trace-Context", "X-Bce-Request-Id", "X-Cls-Requestid", "X-NLS-RequestId", "Request-Id"} {

...
func newInvokeTool(name string, mutating bool) mcp.Tool {
	...
	options := []mcp.ToolOption{
		...
		mcp.WithString("auth_scheme", mcp.Description("Optional provider HTTP authentication scheme: sigv4, sigv4a, acs3, rpc, roa, datahub, oss4, sls, sls4, mns, ots, ots4, tc3, cos, or the provider default.")),

...
func newInvokeTool(name string, mutating bool) mcp.Tool {
	...
	options := []mcp.ToolOption{
		...
		mcp.WithString("registry_instance_id", mcp.Description("Alibaba Cloud ACR Enterprise Edition instance ID used only for internal RAM GetAuthorizationToken; never a Registry credential.")),

...
func newInvokeTool(name string, mutating bool) mcp.Tool {
	...
	options := []mcp.ToolOption{
		...
		mcp.WithString("api_version", mcp.Description("Provider API version used by Alibaba ACS3/RPC/ROA/DataHub/SLS/MNS/MQ/OTS, Tencent TC3 common parameters or headers, and the Azure OpenAI openai-chat-stream query.")),

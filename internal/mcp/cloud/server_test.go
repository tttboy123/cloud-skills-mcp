...
func TestUnifiedMCPContractRoutesGCPProtoJSONDescriptorFile(t *testing.T) {
	...
	result := callCloudTool(t, c, "gcp_api_mutate", map[string]any{
		"service": "test", "operation": "Watch", "auth_scheme": "grpc", "payload_mode": "protobuf-json",
		"method": "POST", "url": "https://example.googleapis.com/test.v1.TestService/Watch",
		"protobuf_descriptor_file": descriptorFile, "body": map[string]any{"name": "Lune"}, "response_file": responseFile,
		"stream_max_messages": 8, "stream_timeout_seconds": 30, "force": true,
	})

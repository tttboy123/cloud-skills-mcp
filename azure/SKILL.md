---
name: azure-cloud
description: Operate or inspect Azure resources through direct authenticated HTTPS, Azure OpenAI Realtime WSS, or Entra-backed Azure Web PubSub JSON and MQTT WSS in cloud-skills-mcp. Use for Azure, ARM, Entra ID, Microsoft Graph, subscriptions, resource groups, Azure OpenAI Realtime, Web PubSub, MQTT, or documented Azure APIs.
---

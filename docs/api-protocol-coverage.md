...
| Tencent Cloud | TC3 API 3.0, API 3.0 v1 HmacSHA1/HmacSHA256 query/form, still-active legacy `*.api.qcloud.com/v2/index.php` HmacSHA1/HmacSHA256 query/form, and COS REST signatures; AKSK/CAM temporary credentials | Product-specific signatures outside TC3/v1/qcloud/COS; long-lived streaming/WebSocket protocols; service-by-service live vectors |

...
| Tencent Cloud | TC3 API 3.0, API 3.0 v1 HmacSHA1/HmacSHA256 query/form, still-active legacy `*.api.qcloud.com/v2/index.php` HmacSHA1/HmacSHA256 query/form, COS REST signatures, and realtime ASR HMAC-SHA1 WSS with internal finite-file streaming; AKSK/CAM credentials within each protocol's documented fields | Product-specific signatures outside TC3/v1/qcloud/COS/ASR; MPS and other remaining long-lived streaming/WebSocket protocols; service-by-service live vectors |

...
| Alibaba Cloud | ACS3 OpenAPI, OSS4 REST, SLS v1 `LOG` HMAC-SHA1, SLS v4 HMAC-SHA256, and MNS/SMQ HMAC-SHA1; credentials-go RAM/OIDC/ECS/AKSK/STS chain | Product-specific signatures or non-HTTP transports outside ACS3/OSS4/SLS/MNS; service-by-service live vectors |

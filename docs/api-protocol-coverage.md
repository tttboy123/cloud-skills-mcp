...
plus bounded observation and atomic NDJSON output. ClientMQTT mutation-gates
publish, persistent-session and Will behavior. QoS 2, oversized topic/message
plans, arbitrary frames, credential

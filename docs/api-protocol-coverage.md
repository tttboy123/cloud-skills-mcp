...
| Alibaba Cloud | ACS3 OpenAPI; legacy RPC/ROA V2; DataHub `DATAHUB` HMAC-SHA1; OSS4; SLS v1/v4; MNS/SMQ; and Tablestore OTS v2/v4; credentials-go RAM/OIDC/ECS/AKSK/STS chain | Product-specific signatures such as OpenSearch, or non-HTTP transports outside implemented families; service-by-service live vectors |

...
| Alibaba Cloud | ACS3 OpenAPI; legacy RPC V2 query/form and ROA V2 resource/header HMAC-SHA1; OSS4 REST; SLS v1 `LOG` HMAC-SHA1; SLS v4 HMAC-SHA256; MNS/SMQ HMAC-SHA1; and Tablestore protobuf HTTP with OTS v2/v4; credentials-go RAM/OIDC/ECS/AKSK/STS chain | Product-specific signatures or non-HTTP transports outside ACS3/RPC/ROA/OSS4/SLS/MNS/OTS; service-by-service live vectors |

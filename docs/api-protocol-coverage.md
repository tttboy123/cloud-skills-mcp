...
|---|---|---|
| AWS | SigV4 header-signed HTTPS; SigV4 S3 `aws-chunked` streaming payload signing with optional signed CRC32, CRC32C, CRC64NVME, SHA-1, or SHA-256 trailer; finite SigV4 HTTP EventStream request signing and raw response-file streaming; SigV4a multi-region ECDSA header signing; AWS SDK default IAM/AKSK/STS chain | Interactive WebSocket sessions and SigV4a chunked payload/trailer signing; service-by-service live vectors |

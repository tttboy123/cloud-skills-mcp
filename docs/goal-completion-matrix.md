...
| Protocol, installer, security and cross-platform build gates | `scripts/ci/protocol-smoke.sh`, `install-smoke.sh`, `build-release.sh`, `.github/workflows/ci.yml` | Current AWS IoT MQTT WSS slice: official AWS CRT query-signing vector, IAM/STS presign containment, MQTT framing/state/acknowledgement, bounded collection, and atomic output vectors; preceding NLS REST run [30771204150](https://github.com/tttboy123/cloud-skills-mcp/actions/runs/30771204150) passed macOS, Ubuntu, ShellCheck, security and release jobs | Current full local gates passed at 80.2% total race coverage; current remote gates pending push |

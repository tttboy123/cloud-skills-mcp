...
| Protocol, installer, security and cross-platform build gates | `scripts/ci/protocol-smoke.sh`, `install-smoke.sh`, `build-release.sh`, `.github/workflows/ci.yml` | Current Tencent large-model podcast WSS slice: official fixed signature/state-machine vectors plus local race, vet, module, protocol/install, Skill, security and release gates; the preceding streaming-text TTS v2 slice passed all remote macOS, Ubuntu, ShellCheck, security and release jobs in GitHub Actions run [30766897175](https://github.com/tttboy123/cloud-skills-mcp/actions/runs/30766897175) | Current local and preceding remote gates passed; current remote gate runs on push |

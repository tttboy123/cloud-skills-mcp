...
| Protocol, installer, security and cross-platform build gates | `scripts/ci/protocol-smoke.sh`, `install-smoke.sh`, `build-release.sh`, `.github/workflows/ci.yml` | Current slice: local race coverage 80.6%, vet, module verification, protocol/install smoke, six Skill validations, actionlint, vulnerability scan and four-target builds; GitHub Actions run [30756239516](https://github.com/tttboy123/cloud-skills-mcp/actions/runs/30756239516) passed macOS, Ubuntu, ShellCheck, security and release jobs on commit `edf62a3` | Local and remote hermetic gates passed |

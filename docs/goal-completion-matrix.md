...
Latest verified slice: AWS IoT Core now supports finite clean-start MQTT 3.1.1
and MQTT 5 subscriptions over IAM/SigV4 WSS. MQTT 5 adds strict
CONNECT/CONNACK/SUBSCRIBE/SUBACK/PUBLISH/DISCONNECT property and reason-code
handling, AWS QoS 0/1 enforcement, receive and 128 KiB packet bounds, broker
keepalive, supported application metadata, and atomic failure behavior while
keeping the signed URL and STS token internal. Implementation commit
`b9b23318ce9c7f14172f282cfa9f878498b14205` passed remote macOS, Ubuntu,
ShellCheck, Actionlint, govulncheck and four-platform release verification in
[CI run 30797921483](https://github.com/tttboy123/cloud-skills-mcp/actions/runs/30797921483).
...
Actionlint, govulncheck, four-platform archives and a five-second MQTT 5 parser
fuzz run (162,854 executions) also passed.

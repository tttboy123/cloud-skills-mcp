...
| Protocol, installer, security and cross-platform build gates | `scripts/ci/protocol-smoke.sh`, `install-smoke.sh`, `build-release.sh`, `.github/workflows/ci.yml` | Current Azure Web PubSub reliable JSON slice covers exact subprotocol negotiation, uint64 sequence acknowledgement, duplicate suppression, internal reconnection-token containment, transient reconnect retry, expired-state termination, and ordered pending publisher resend; preceding standard JSON run [30778472702](https://github.com/tttboy123/cloud-skills-mcp/actions/runs/30778472702) passed macOS, Ubuntu, ShellCheck, security and release jobs | Module verification, formatting, vet, full race suite (80.1% total coverage), build, protocol/install smoke, shell syntax, six-Skill validation, Actionlint, govulncheck, and four-platform release builds passed locally; local ShellCheck unavailable; current remote gates pending push |

...
| Protocol, installer, security and cross-platform build gates | `scripts/ci/protocol-smoke.sh`, `install-smoke.sh`, `build-release.sh`, `.github/workflows/ci.yml` | Local race/coverage, vet, module verification, ShellCheck, actionlint, vulnerability scan and four-target builds; GitHub Actions run [30749749296](https://github.com/tttboy123/cloud-skills-mcp/actions/runs/30749749296) passed on commit `c43b68d` | Local and remote gates passed |

...
| Protocol, installer, security and cross-platform build gates | `scripts/ci/protocol-smoke.sh`, `install-smoke.sh`, `build-release.sh`, `.github/workflows/ci.yml` | Current AWS AppSync Events WSS slice: distinct IAM connect/channel SigV4 authorization, dynamic auth-subprotocol containment, protocol acknowledgement/data/unsubscribe, bounded collection, and atomic output vectors; preceding AWS IoT run [30772353281](https://github.com/tttboy123/cloud-skills-mcp/actions/runs/30772353281) passed macOS, Ubuntu, ShellCheck, security and release jobs | Current full local gates passed at 80.1% total race coverage; current remote gates pending push |

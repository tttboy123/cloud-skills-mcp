...
| Protocol, installer, security and cross-platform build gates | `scripts/ci/protocol-smoke.sh`, `install-smoke.sh`, `build-release.sh`, `.github/workflows/ci.yml` | Current Alibaba NLS REST slice: exact ASR/TTS HTTPS shapes, internal header-token containment, JSON business-status validation, binary body and atomic audio vectors; preceding NLS WSS remote run [30770640367](https://github.com/tttboy123/cloud-skills-mcp/actions/runs/30770640367) passed macOS, Ubuntu, ShellCheck, security and release jobs | Current full local gates passed at 80.1% total race coverage; current remote gates pending push |

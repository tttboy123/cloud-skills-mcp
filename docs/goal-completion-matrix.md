...
| Protocol, installer, security and cross-platform build gates | `scripts/ci/protocol-smoke.sh`, `install-smoke.sh`, `build-release.sh`, `.github/workflows/ci.yml` | Current AWS Transcribe WSS slice: fixed SigV4 presign, chained double-EventStream/configuration/audio/terminal vectors plus local gates; the preceding Tencent large-model podcast slice passed all remote macOS, Ubuntu, ShellCheck, security and release jobs in GitHub Actions run [30767572304](https://github.com/tttboy123/cloud-skills-mcp/actions/runs/30767572304) | Current local and preceding remote gates passed; current remote gate runs on push |

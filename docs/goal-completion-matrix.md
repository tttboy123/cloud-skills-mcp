...
| Protocol, installer, security and cross-platform build gates | `scripts/ci/protocol-smoke.sh`, `install-smoke.sh`, `build-release.sh`, `.github/workflows/ci.yml` | Current generic AWS SigV4 WSS slice: exact endpoint/query/header signing, credential containment, mutation-only classification, bounded JSON/text/binary plans, and atomic sanitized output vectors; preceding AWS AppSync GraphQL run [30773539007](https://github.com/tttboy123/cloud-skills-mcp/actions/runs/30773539007) passed macOS, Ubuntu, ShellCheck, security and release jobs | Current local tests, race coverage (80.2%), vet, module verification, six-Skill validation, protocol/install smoke, shell syntax, Actionlint, govulncheck, and four-platform release builds passed; local ShellCheck unavailable; current remote gates pending push |

...
| Protocol, installer, security and cross-platform build gates | `scripts/ci/protocol-smoke.sh`, `install-smoke.sh`, `build-release.sh`, `.github/workflows/ci.yml` | Current Tencent ASR CAM temporary-token correction: official SDK signing vector plus local race, vet, module, protocol/install, Skill, security and release gates; the preceding standard realtime TTS WSS slice passed all remote macOS, Ubuntu, ShellCheck, security and release jobs in GitHub Actions run [30766312078](https://github.com/tttboy123/cloud-skills-mcp/actions/runs/30766312078) | Current local and preceding remote gates passed; current remote gate runs on push |

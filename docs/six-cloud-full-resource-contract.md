...
| Alibaba Cloud | Direct ACS3 OpenAPI, legacy RPC V2, OSS4 object, SLS v1/v4, MNS and OTS v2/v4 protobuf signed HTTPS | Official credentials-go chain: RAM/OIDC/ECS role, STS, or AK/SK env |

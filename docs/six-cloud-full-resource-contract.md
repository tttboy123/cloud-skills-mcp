...
| Tencent Cloud | Direct API 3.0 TC3 and v1 HmacSHA1/HmacSHA256 HTTPS, still-active qcloud API 2017 query/form HTTPS, plus COS data-plane signed HTTPS | SecretId/SecretKey or CAM/STS temporary credentials injected into the server environment |

...
| Alibaba Cloud | Direct ACS3 OpenAPI, legacy RPC/ROA V2, DataHub, OpenSearch V3, MaxCompute ODPS v2/v4 project/data/Tunnel, OSS4 object, SLS v1/v4, MNS and OTS v2/v4 signed HTTPS | Official credentials-go chain: RAM/OIDC/ECS role, STS, or AK/SK env |

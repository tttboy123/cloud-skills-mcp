...
The universal adapter signs general OpenAPI requests with ACS3, OSS data-plane requests with OSS4, SLS data-plane requests with v1 or v4, and MNS requests with its service-specific HMAC-SHA1 protocol. It never executes Alibaba Cloud CLI.

...
- Google Cloud IoT Core retirement (service discontinued 2023-08-16, Device Manager APIs unavailable): https://cloud.google.com/iot/docs/migration
- Memorystore for Redis OSS Redis AUTH and IAM authentication for the RESP client protocol: https://cloud.google.com/memorystore/docs/redis/auth and https://cloud.google.com/memorystore/docs/cluster/manage-iam-auth
- Managed Service for Apache Kafka open-source Kafka API authentication (SASL/OAUTHBEARER over ADC or SASL/PLAIN): https://cloud.google.com/managed-service-for-apache-kafka/docs/authentication-kafka
- Cloud SQL connection options (MySQL/PostgreSQL/SQL Server wire protocols with Cloud SQL connectors or SSL/TLS client certificates): https://cloud.google.com/sql/docs/postgres/connect-overview
- Live Streaming API SRT/RTMP input ingest and HLS/DASH output delivery as the media plane: https://cloud.google.com/livestream/docs/overview

...
- Artifact Registry Docker/OCI Distribution API support and monolithic-upload requirement: https://cloud.google.com/artifact-registry/docs/reference/docker-api
- Artifact Registry Docker authentication and ADC-compatible standalone credential flow: https://cloud.google.com/artifact-registry/docs/docker/authentication
- Artifact Registry repository and image names: https://cloud.google.com/artifact-registry/docs/docker/names
- Artifact Registry-backed `gcr.io` repository host mapping: https://cloud.google.com/artifact-registry/docs/transition/gcr-repositories
